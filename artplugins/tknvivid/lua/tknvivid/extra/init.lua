...
function M.setup()
  local tknvivid = require("tknvivid.theme")
  ...
  -- tknvivid.setup({ plugins = { all = true } })
  for _, extra in ipairs(names) do
    local info = M.extras[extra]
    local plugin = require("tknvivid.extra." .. extra)
    for style, style_name in pairs(styles) do
      local colors, groups, opts = tknvivid.setup({ style = style, plugins = { all = true } })
      local fname = extra
      ...
      colors["_upstream_url"] = "https://github.com/folke/tknvivid.nvim/raw/main/extras/" .. fname
      colors["_style_name"] = "Tokyo Night" .. style_name
      colors["_name"] = "tknvivid_" .. style
      colors["_style"] = style
      print("[write] " .. fname)
