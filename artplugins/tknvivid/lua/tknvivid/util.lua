...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("tknvivid.hsluv")
    if color ~= "NONE" then
...
---@param groups tknvivid.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/tknvivid-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, tknvivid.Cache
