...
{
  "ui": {
    "theme": "/absolute/path/to/tknvivid_night.json"
  }
}
```
...
- **tknvivid_storm.json**: Tokyo Night Storm (Dark)
- **tknvivid_moon.json**: Tokyo Night Moon (Dark)
- **tknvivid_night.json**: Tokyo Night (Dark)
- **tknvivid_day.json**: Tokyo Night Day (Light)
